# fuel_prices_lakehouse

The 'fuel_prices_lakehouse' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/fuel_prices_lakehouse/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] fuel_prices_lakehouse_etl` to your workspace.
